...
function getbms(page, c, domain) {
  $.get("/bms/"+page, { cursor: c, domain: domain}, function(data) {
...
function archive(id) {
  $.get('/archive', { bm: id }, function() {
    $(".row-" + id).hide();
  });}

function trash(id) {
  $.get('/trash', { bm: id }, function() {
    $(".row-" + id).hide();
  });}

function star(id) {
  $.get('/star', { bm: id }, function(data) {
    $(".star-" + id).html(data);
  });}

function share(id) {
  $.get("/share", { id: id }, function(eye) {
    $(".share-" + id).html(eye);
...
function setnotify (id, notify) {
  $.get('/setnotify', {feed: id, notify: notify} );}

function sync_feed (id) {
  $.get('/checkfeed', {feed: id} );}
